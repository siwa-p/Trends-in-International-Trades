...
DATA_TYPE_COLUMNS = {
    "porths": {
        "export": "PORT,CTY_CODE,CTY_NAME,E_COMMODITY,E_COMMODITY_SDESC,ALL_VAL_MO,LAST_UPDATE,AIR_VAL_MO,AIR_WGT_MO,VES_VAL_MO,VES_WGT_MO",
        "import": "PORT,CTY_CODE,CTY_NAME,I_COMMODITY,I_COMMODITY_SDESC,GEN_VAL_MO,LAST_UPDATE,AIR_VAL_MO,AIR_WGT_MO,VES_VAL_MO,VES_WGT_MO"
    },
    "statehs": {
